    ...
    >
      ...
      <header
        style={{
          padding: "80px 20px",
          textAlign: "center",
          background: "linear-gradient(135deg, #000000ff, #2d2936ff)",
          color: "white",
        }}
      >
        ...
        <p style={{ fontSize: "22px", maxWidth: "850px", margin: "0 auto", lineHeight: "1.6" }}>
          This is a "Physical AI & Humanoid Robotics" textbook that explores the intersection of 
          artificial intelligence, robotics & human-like machines. A complete and practical learning system,
          Easy to understand:
        </p>
      ...
      <section style={{ padding: "60px 20px", maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <p style={{ fontSize: "20px", lineHeight: "1.7", color: "#444", textAlign: "center" }}>
          ...
          This book provides a thorough introduction to the field , covering fundamentals concepts, 
          recent advances, and future directions. It's a valuable resource for students, researchers, 
          and professionals in Robotics, AI & related fields.
        </p>
      </section>

      {/* MODULE CARDS */}
      <section style={{ padding: "60px 20px",  background: "linear-gradient(135deg, #000000ff, #2d2936ff)" }}>
        <h2 style={{ fontSize: "32px" ,color: "white", marginBottom: "40px", textAlign: "center" }}>
          Explore The Book
        </h2>
      ...
      >
        ...
        Physical AI, embodied intelligence, and Humanoid Robotics designed to resemble humans in appearance & behavior. 
